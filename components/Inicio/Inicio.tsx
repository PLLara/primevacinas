...
const HomeContainerExames: any = styled('div')({
  display: `flex`,
  position: `relative`,
  isolation: `isolate`,
  flexDirection: `row`,
...
function DefaultViewportAnimation(props: {
  children: React.ReactNode,
}) {
  return <motion.div whileInView={{
    opacity: 1,
    offsetDistance: 300,
  }}
  viewport={{
...
function Inicio(props: InicioProps): JSX.Element {
  return (
    <Inicio1 className={props.className}>
      <Header1 />
      <Main>
        <div style={{
          display: `flex`,
  ...
  | Biologia Molecular`}
                    ...
                    <motion.button className="w-72 h-12 mt-16" whileTap={
                      {
                        scale: 0.98,
                      }
                    }
                    ...
                    >
                      <div className="flex items-center justify-center flex-1 h-full py-2.5 border rounded-lg border-red-500" style={{
                        backgroundColor: '#2A060A',
                      }}>
                        <p className="text-base font-bold leading-relaxed text-center text-white">Consultar Resultados</p>
                      </div>
                    </motion.button>
...
Lorem ipsum dolor sit amet, consectetur adipiscing elit. Etiam ac velit turpis.`}
              ...
              <motion.button className="w-72 h-12 mt-12"
                whileTap={
                  {
                    scale: 0.98,
                  }
              ...
              >
                <div className="flex items-center justify-center flex-1 h-full py-3 px-12 bg-red-500 rounded-lg">
                  <p className="text-sm font-bold leading-snug text-white">ENCONTRAR MAIS VACINAS</p>
                </div>
              </motion.button>
            </HomeOndeVoceEstiverMain>
          </HomeOndeVoceEstiver>
